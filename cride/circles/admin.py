...
class CircleAdmin(admin.ModelAdmin):
    ...
    def download_todays_rides(self, request, queryset):
        ...
        writer.writerow(['id','passengers','departure_location','departure_date','arrival_location','arrival_date'])
        for ride in rides:
            writer.writerow([
                str(ride.id),
        ...
        return response
        download_todays_rides.short_description = 'Download today rides'